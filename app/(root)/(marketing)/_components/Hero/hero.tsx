        ...
        <SectionContainer>
            <div className="sm:py-18 gap-4 lg:gap-8 py-16 md:py-24 lg:py-24 flex flex-col items-center justify-center text-center">
                <div className="flex items-center justify-center flex-col">
                    ...
                    <p className='pt-2 text-foreground my-3 text-sm sm:mt-5 lg:mb-0 sm:text-base lg:text-base'>ShortsHub is a free and open-source platform that allows you to share short videos with your friends.</p>
                </div>
